...
public class SpecialistAdapter extends RecyclerView.Adapter<SpecialistAdapter.CardViewHolder> {
    ...
    ArrayList<com.example.patient_android_app.SpecialistModel> CardLocations;
    RecyclerViewClickListener listener;

    public SpecialistAdapter(ArrayList<com.example.patient_android_app.SpecialistModel> CardLocations, RecyclerViewClickListener listener) {
    ...
    public CardViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        View view = LayoutInflater.from(parent.getContext()).inflate(R.layout.activity_specialist_adapter, parent, false);
    ...
    public void onBindViewHolder(@NonNull CardViewHolder holder, int position) {
        ...
        com.example.patient_android_app.SpecialistModel cardHelperClass = CardLocations.get(position);
